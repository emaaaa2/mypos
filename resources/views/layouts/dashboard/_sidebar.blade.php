    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
           ...
           @if (auth()->user()->hasPermission('read_users'))
            <li><a href="{{ route('dashboard.users.index') }}"><i class="fa fa-users"></i></i><span>@lang('site.users')</span></a></li>
           @endif

            
             {{-- categories --}}
            @if (auth()->user()->hasPermission('read_categories'))
            <li><a href="{{ route('dashboard.categories.index') }}"><i class="fa fa-cart-plus" aria-hidden="true"></i><span>@lang('site.categories')</span></a></li>
           @endif

            {{-- products --}}
            @if (auth()->user()->hasPermission('read_products'))
            <li><a href="{{ route('dashboard.products.index') }}"><i class="ion ion-bag"></i></i></i><span>@lang('site.products')</span></a></li>
           @endif
