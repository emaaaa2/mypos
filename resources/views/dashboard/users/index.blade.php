 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('dashboard.index') }}">@lang('site.dashboard')</a></li>
            </ol>
        </section>
                        ...
                        <table class="table table-hover">
                           ...
                           @foreach($users as $index => $user) 
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td><img src="{{ $user->image_path }}" style="width: 70px;" class="img-thumbnail" alt=""></td>                                    <td>
                                 ...
                                 @if (auth()->user()->hasPermission('update_users'))
                                      ...
                                      @else
                                        <button class="btn btn-info disabled"><i class="fa fa-edit"></i>@lang('site.edit')</button>
                                        @endif
